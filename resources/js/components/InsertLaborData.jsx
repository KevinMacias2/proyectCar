...
const InsertLaborData = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post("http://localhost/proyectCar/public/api/store_laborData",
      formData,
      {
        headers: {
            ...
            <Stack>
                ...
                <Stack gap={1} className="col-md-4 mx-auto shadow-lg p-3 mb-5 mt-4 bg-dark text-white rounded">
                    ...
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control type="text" placeholder="Name Job" required name="name_Job" value={formValue.name_job} onChange={onChange} />
                    ...
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control type="text" placeholder="AddressJob" required name="address_Job" value={formValue.address_job} onChange={onChange} />
                        <Form.Text className="text-muted"></Form.Text>
                    ...
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control type="text" placeholder="Phone" required name="phone" value={formValue.phone} onChange={onChange} />
                        <Form.Text className="text-muted"></Form.Text>
